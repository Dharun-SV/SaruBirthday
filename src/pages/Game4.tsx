...
export default function Game4() {
  ...
  const getLoveMessage = (percentage: number) => {
    if (percentage >= 90) {
      return { message: 'This is True Love!', emoji: '[LOVE3]' }
    } else if (percentage >= 80) {
      return { message: 'Forever Together!', emoji: '[LOVE2]' }
    } else if (percentage >= 70) {
      return { message: 'Deep Love!', emoji: '[LOVE]' }
    } else if (percentage >= 60) {
      return { message: 'Strong Connection!', emoji: '[OK]' }
    } else if (percentage >= 50) {
      return { message: 'Good Match!', emoji: '[GOOD]' }
    } else {
      return { message: "You'll fall in love more!", emoji: '[MORE]' }
    }
  }
        ...
        <div className="game4-content">
          ...
          <div className="result-card">
            <div className="couple-names">
              <h2>{yourName}</h2>
              <span className="love-symbol">[LOVE]</span>
              <h2>{herName}</h2>
            </div>
            ...
            {lovePercentage >= 90 && (
              <p className="special-message">
                You two are meant to be! This is the kind of love that lasts forever. So grateful to have you in my life.
              </p>
            )}
    ...
    <div className="game4-container">
      ...
      <div className="game4-content">
        ...
        <div className="form-card">
          <p className="form-description">Let's calculate how much love there is between us!</p>
        ...
        <div className="info-card">
          ...
          <ul>
            <li>Love makes our hearts beat faster</li>
