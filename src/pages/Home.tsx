    ...
    <div className="home-container">
      ...
      <div className="home-content">
        ...
        <div className="greeting-card">
          ...
          <p className="greeting-subtext">This day is dedicated to celebrating YOU!</p>
        </div>
        ...
        <div className="games-section">
          ...
          <div className="games-grid">
            <Link to="/memory-game" className="game-card">
              <div className="game-icon">[MEM]</div>
              <h3>Memory Game</h3>
            ...
            <Link to="/emoji-match" className="game-card">
              <div className="game-icon">[EM]</div>
              <h3>Emoji Match</h3>
              <p>Match symbols that represent your qualities!</p>
            </Link>

            <Link to="/love-calculator" className="game-card">
              <div className="game-icon">[LOVE]</div>
        ...
        <div className="special-message">
          ...
          <p>
            You make every moment special. Your smile brightens my day, and your presence makes everything
            better. On your birthday, I want you to feel as loved and cherished as you truly are. Here's
            to another year of laughter, adventures, and falling in love with you all over again!
          </p>
        </div>
      </div>
    </div>
